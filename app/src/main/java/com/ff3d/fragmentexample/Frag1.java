...
public class Frag1 extends Fragment {
    ...
    public static Frag1 newInstance(String date) {
        Frag1 fragment = new Frag1();
        Bundle args = new Bundle();
        args.putString(ARG_DATETIME, date);
    ...
    public void UpdateDateTime(View view){
    ...
    public void UpdateDateTime2(View view, String data){
        TextView tvDateTime = (TextView) view.findViewById(R.id.TvDateTime);
